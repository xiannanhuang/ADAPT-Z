...
class Ada_fineture:
    ...
    def online(self, test_loader):
        ...
        truth=[]
        x_list=[]
        if self.args.model=='SOFTS' or self.args.model=='TimesNet':
            self.optimizer2=optim.Adam(self.model.projection.parameters(),lr=settings[self.args.model][self.args.data]['online_lr'])
