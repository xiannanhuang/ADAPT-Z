...
def main(model=None,data=None,data_path=None,seq_len=None,pred_len=None,seed=None):
    ...
    # 保存最终模型
    save_path = os.path.join(args.checkpoints, f'{args.model}_{args.data}_{args.seq_len}_{args.pred_len}_{args.seed}.pth')
    ...
    output_path = "experiment_ori_PatchTST.csv"
