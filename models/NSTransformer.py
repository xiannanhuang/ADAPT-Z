...
from models.encoders.NSTransformer_EncDec import Encoder, EncoderLayer, Decoder, DecoderLayer
from models.blocks.DSSelfAttention_Family import DSAttention, AttentionLayer
...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc=None, dec_inp=None, x_mark_dec=None):
    ...
    def forward(self, x_enc, x_mark_enc=None, dec_inp=None, x_mark_dec=None, mask=None):
        x_mark_enc=None
