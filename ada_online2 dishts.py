...
from models.DishTS_model_z import Model
...
def finetune(model=None,data=None,data_path=None,seq_len=None,pred_len=None,seed=None,ogd_step=0,ema=0.7,z_loc=1):
    ...
    try:
        ...
        model_forecast = model_module.Model(args, args.seq_len)
        norm_model=DishTS(args)
        model=Model(args,model_forecast,norm_model)
    ...
    output_path = "itrans_adap_dishts.csv"
